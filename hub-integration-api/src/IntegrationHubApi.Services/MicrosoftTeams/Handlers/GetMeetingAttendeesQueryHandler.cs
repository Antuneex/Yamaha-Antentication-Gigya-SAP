...
{
    internal class GetMeetingAttendeesQueryHandler : BaseMediatR, IRequestHandler<GetMeetingAttendeesQuery, IEnumerable<Atendee>>
    {
        ...
        public GetMeetingAttendeesQueryHandler(IHttpContextAccessor httpContextAccessor,
        ...
        public async Task<IEnumerable<Atendee>> Handle(GetMeetingAttendeesQuery request, CancellationToken cancellationToken)
        {
            ...
            var attendees = await _graphApi.GetAttendees(request.Id, config, request.Token);
